...
BlockI::BlockI(const CellsArray& array, BlockRotationState startRotationState) 
    : Block(array, startRotationState)
{
}

bool BlockI::tryRotate(Grid& grid) {
    ...
    if (getRotationState() == BlockRotationState::DEG_0) {
        ...
        expectedCells[0] = &grid.getArray_mut()[newRow0][newCol0];
        expectedCells[1] = &grid.getArray_mut()[newRow1][newCol1];
        expectedCells[2] = &grid.getArray_mut()[newRow2][newCol2];
        expectedCells[3] = &grid.getArray_mut()[newRow3][newCol3];
...
bool BlockI::tryRotateReversed(Grid& grid) {
    auto& cells = getCells_mut();
    CellsArray expectedCells;
